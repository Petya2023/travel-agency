<header class="header">
    <div class="header__text-box">
        <div class="header__text-box__title js--nav montserrat">
            Открий света с нас
        </div>
    </div>
    <?php get_header(); ?>
...
<section class="section">
    <div class="container">
        ...
        <div class="row u-negative-margin-top">
            <?php
                ...
                <a href="<?php the_permalink(); ?>">
                    <div class="scene">
                        <div class="card">
                            ...
                            <div class="card__bottom u-text-center">
                                <h5 class="card__title u-margin-bottom-huge u-uppercase"><?php the_title(); ?>
                                </h5>
